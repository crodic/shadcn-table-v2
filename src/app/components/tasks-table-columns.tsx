...
import { ArrowUpDown, CalendarIcon, CircleDashed, Clock, Code, Ellipsis, Text } from 'lucide-react';
...
export function getTasksTableColumns({
    ...
    return [
            ...
            cell: ({ row }) => {
                ...
                return (
                    <div className="flex items-center gap-2">
                        ...
                        <span className="max-w-80 truncate font-medium">{row.getValue('title')}</span>
                    </div>
                );
            },
            meta: {
        ...
        },
        {
            ...
            cell: ({ cell }) => {
                const status = tasks.status.enumValues.find((status) => status === cell.getValue<Task['status']>());
